...
/// Separated hour-row cells for planner day columns and time gutter.
class PlannerHourCellPainter extends CustomPainter {
  const PlannerHourCellPainter({
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var hour = 0; hour < hourCount; hour++) {
      ...
      final hourHeight = PlannerSlotGeometry.yForMinutes(
          ...
          y;
      final cellHeight = hourHeight - gap;
  ...
  @override
  bool shouldRepaint(PlannerHourCellPainter oldDelegate) =>
